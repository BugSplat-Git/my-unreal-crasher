...
UNREALROOTPATH = /home/bobby/Desktop/github/UnrealEngine
GAMEPROJECTFILE =/home/bobby/Desktop/github/my-unreal-crasher/MyUnrealCrasher.uproject

TARGETS = \
	MyUnrealCrasher-Linux-Debug  \
	MyUnrealCrasher-Linux-DebugGame  \
	MyUnrealCrasher-Linux-Test  \
	MyUnrealCrasher-Linux-Shipping  \
	MyUnrealCrasher \
	MyUnrealCrasherEditor-Linux-Debug  \
	MyUnrealCrasherEditor-Linux-DebugGame  \
	MyUnrealCrasherEditor-Linux-Test  \
	MyUnrealCrasherEditor-Linux-Shipping  \
	MyUnrealCrasherEditor \
...
MyUnrealCrasher-Linux-Debug:
	 $(PROJECTBUILD) MyUnrealCrasher Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasher-Linux-DebugGame:
	 $(PROJECTBUILD) MyUnrealCrasher Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasher-Linux-Test:
	 $(PROJECTBUILD) MyUnrealCrasher Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasher-Linux-Shipping:
	 $(PROJECTBUILD) MyUnrealCrasher Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasher:
	 $(PROJECTBUILD) MyUnrealCrasher Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasherEditor-Linux-Debug:
	 $(PROJECTBUILD) MyUnrealCrasherEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasherEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MyUnrealCrasherEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasherEditor-Linux-Test:
	 $(PROJECTBUILD) MyUnrealCrasherEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasherEditor-Linux-Shipping:
	 $(PROJECTBUILD) MyUnrealCrasherEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyUnrealCrasherEditor:
	 $(PROJECTBUILD) MyUnrealCrasherEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
